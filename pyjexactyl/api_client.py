...
from pyjexactyl.api.client.client_api import ClientAPI
from pyjexactyl.api.locations import Locations
from pyjexactyl.api.nests import Nests
from pyjexactyl.api.nodes import Nodes
from pyjexactyl.api.servers import Servers
from pyjexactyl.api.user import Users
...
class Jexactyl(object):
    ...
    @property
    def users(self):
        self._user = Users(self._url, self._api_key, self._session)
        return self._user
