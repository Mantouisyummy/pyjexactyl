...
from pyjexactyl.dataclasses.application.base import UserDataclass


class Users(JexactylAPI):
    """Class for interacting with the Jexactyl Client API."""
    ...
    def list_users(self, email=None, uuid=None, username=None,
        ...
        return PaginatedResponse(self, endpoint, response, dataclass_object=UserDataclass)
    ...
    def get_user_info(self, user_id=None, external_id=None, detail=True,
        ...
        response = self._api_request(endpoint=endpoint, includes=includes,
                                     params=params)
        return UserDataclass(base.parse_response(response, detail=detail))
    ...
    def create_user(self, username, email, first_name, last_name,
        ...
        response = self._api_request(endpoint='application/users',
                                     mode='POST', data=data)
        return UserDataclass.from_dict(base.parse_response(response, detail=True))
    ...
    def delete_user(self, user_id=None, external_id=None, detail=True):
        ...
        return UserDataclass.from_dict(base.parse_response(response, detail=detail))
