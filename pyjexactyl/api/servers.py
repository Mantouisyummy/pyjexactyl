...
from pyjexactyl.dataclasses.application.base import ServerDataclass, DatabaseListDataclass, DatabaseDataclass


class Servers(base.JexactylAPI):
    ...
    def list_servers(self, includes=None, params=None):
        ...
        response = base.parse_response(
            self._api_request(endpoint=endpoint, includes=includes,
                              params=params),
            detail=True)
        return PaginatedResponse(self, endpoint, response, dataclass_object=ServerDataclass)
    ...
    def get_server_info(self, server_id=None, external_id=None, detail=False,
        ...
        response = self._api_request(endpoint=endpoint, includes=includes,
                                     params=params)
        return ServerDataclass.from_dict(base.parse_response(response, detail))
    ...
    def list_server_databases(self, server_id, includes=None, params=None):
        ...
        response = self._api_request(endpoint=endpoint, includes=includes,
                                     params=params)
        return PaginatedResponse(self, endpoint, response, dataclass_object=DatabaseListDataclass)
    ...
    def create_server_database(self, server_id):
        ...
        response = self._api_request(
            endpoint='application/servers/{}/databases'.format(server_id),
            mode='POST')
        return DatabaseDataclass.from_dict(base.parse_response(response))
    ...
    def create_server(self, name, user_id, nest_id, egg_id, memory_limit,
        ...
        return ServerDataclass(base.parse_response(response))
