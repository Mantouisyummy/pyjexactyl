...
from pyjexactyl.constants import USE_SSL
from pyjexactyl.responses import PaginatedResponse
from pyjexactyl.api import base

from pyjexactyl.dataclasses.application.base import NodeDataclass, AllocationDataclass, NodeConfiguration

class Nodes(JexactylAPI):
    ...
    def list_nodes(self, includes=None, params=None):
        ...
        return PaginatedResponse(self, endpoint, response, dataclass_object=NodeDataclass)
    ...
    def get_node_config(self, node_id):
        ...
        return NodeConfiguration(response)
    ...
    def get_node_details(self, node_id, includes=None, params=None):
        ...
        response = self._api_request(
            ...
            includes=includes, params=params)
        return NodeDataclass(base.parse_response(response))
    ...
    def list_node_allocations(self, node_id, includes=None, params=None):
        ...
        response = self._api_request(endpoint=endpoint, includes=includes,
                                     params=params)
        return PaginatedResponse(self, endpoint, response, dataclass_object=AllocationDataclass)
