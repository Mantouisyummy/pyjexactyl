...
from pyjexactyl.constants import REQUEST_TYPES
from pyjexactyl.exceptions import BadRequestError
from pyjexactyl.exceptions import JexactylApiError
...
class JexactylAPI(object):
    ...
    def _api_request(self, endpoint, mode='GET', params=None, data=None,
        ...
        if response.status_code in (400, 422):
            raise JexactylApiError('API Request resulted in errors: %s' %
